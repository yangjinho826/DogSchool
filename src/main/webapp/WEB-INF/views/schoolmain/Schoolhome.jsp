...
<body>
	<section id="Schoolhome">
		...
		<h2 class="Schoolhome_title">공지사항</h2>
		...
		<article id="Schoolhome_priceTag">
			<h2 class="Schoolhome_title">가격표</h2>
		...
		<article id="Schoolhome_postscript">
			<h2 class="Schoolhome_title">선생님 후기</h2>
			<c:forEach var="fp" items="${fivepostscript }">
			<table class="Schoolhome_postscript">
				<tr class="Schoolhome_postscript_tr">
				 <td class="Schoolhome_postscript_td">${fp.p_title }</td>
				 <td class="Schoolhome_postscript_td">${fp.p_id }</td>
				 <td class="Schoolhome_postscript_td"><fmt:formatDate value="${fp.p_date }" type="both" dateStyle="short" timeStyle="short"/></td>
				</tr>
			</table>
			</c:forEach>
		</article >
	...
	<aside class="Schoolhome_schedule">
		<h2 class="Schoolhome_title">시간표</h2>
